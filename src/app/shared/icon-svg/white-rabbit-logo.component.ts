...
@Component({
  selector: 'app-white-rabbit-logo',
  template: `
    <svg
      width="50px"
      height="50px"
...
export class WhiteRabbitLogoComponent {
  @Input() class = '';
}
